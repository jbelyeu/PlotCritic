...
app.controller("svCtrl", function($scope, $rootScope, $timeout, $http, $window) {
	...
	var sendScore = function(flag) {
		...
		var poolData = {
		    UserPoolId : 'us-east-1_CklDMMDxI', // your user pool id here
		    ClientId : '351j9udv6ctdp34u7di27q66do' // your app client id here
		};
		var userPool = new AWSCognito.CognitoIdentityServiceProvider.CognitoUserPool(poolData);
		var poolClient = userPool.client;

		var attributeList = []; 
		var dataEmail = {
		    Name : 'email',
		    Value : 'jrbelyeu@gmail.com' // your email here
		};
		var attributeEmail = new AWSCognito.CognitoIdentityServiceProvider.CognitoUserAttribute(dataEmail);
		attributeList.push(attributeEmail);
		 
		 // Sign user up (depends on pool object)
		//*****************************************************************************************
		// var cognitoUser;
		// var username = "jrbelyeu@gmail.com";
		...
		// Confirm user email (depends on pool object)
		//*****************************************************************************************
		// var confirmationCode = '417317';
		...
		// poolClient.makeUnauthenticatedRequest('confirmSignUp', {
		...
		// Sign user in (depends on pool object)
		//*****************************************************************************************
		var username = "jrbelyeu@gmail.com";
		var password = "Password1@";
		...
		// get AWS credentials (depends on pool object and user)
		//*****************************************************************************************
		AWS.config.credentials = new AWS.CognitoIdentityCredentials({
		    IdentityPoolId: 'us-east-1:9e69988e-9b46-4dad-9d9e-e4caa9259f9f'
		});
